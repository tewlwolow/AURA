...
local function init()
    ...
    local floraSounds = config.floraSounds
    ...
    if floraSounds then
        mwse.log(string.format("[AURA %s] %s floraSounds.lua.", version, messages.loadingFile))
        dofile("Data Files\\MWSE\\mods\\tew\\AURA\\Misc\\floraSounds.lua")
    end
end
